...
const Register = ()=>{
  ...
  function handleSubmit(e)
  {
    ...
    axios.post("http://localhost:8080/user/register/",{ user , email:auth , password },{ withCredentails: true })
      .then((data)=>{
  ...
  useEffect(()=>{
    axios.get("/get/cookie/email/confirm",{ withCredentails: true })
      .then((data)=>{
        console.log(data.data);
        // console.log();
        ...
        <div className="form">
          <form onSubmit={handleSubmit}>
            <div className="field-container user-field">
              <input onChange={ handleChange } type="text" name="username" id="username" value={ user }/>
            </div>
            <div className="field-container email-field">
              <input type="email" name="email" id="email" value={auth} readOnly/>
            </div>
